// Development-only snapshots of the original itemsData.ts and seedCraftingRecipes.ts.
// Keep names, effects, ingredients, and rates aligned with those server definitions.
// This module deliberately imports no database, server, or authentication code.
...
const uncommonTreasures: ItemDef[] = [
  ...
  { name: "Jade Ring", description: "A storage ring that adds 5 extra bag slots when equipped (total: 25 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "uncommon", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 5, icon: "💍" },
...
const rareTreasures: ItemDef[] = [
  ...
  { name: "Spirit Ring", description: "A spirit-infused ring that adds 15 extra bag slots when equipped (total: 35 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "rare", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 15, icon: "💍" },
  ...
  { name: "Cultivation Ring", description: "A cultivator's ring that adds 10 extra bag slots when equipped (total: 30 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "rare", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 10, icon: "💍" },
...
const epicTreasures: ItemDef[] = [
  ...
  { name: "Spatial Pouch", description: "A spatial artifact that adds 20 extra bag slots when equipped (total: 40 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "epic", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 20, icon: "👜" },
  ...
  { name: "Void Ring", description: "A void-forged ring that adds 25 extra bag slots when equipped (total: 45 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "epic", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 25, icon: "💍" },
...
const mythicTreasures: ItemDef[] = [
  ...
  { name: "Immortal Storage Ring", description: "An immortal-grade ring that adds 50 extra bag slots when equipped (total: 70 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "mythic", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 50, icon: "💍" },
...
export const DEMO_ITEM_DEFS: ItemDef[] = [
  ...commonPills,
  ...uncommonPills,
  ...rarePills,
  ...epicPills,
...
export const DEMO_RECIPE_DEFS: RecipeDef[] = [
  // ── Common alchemy ─────────────────────────────────────────────────────────
  {
