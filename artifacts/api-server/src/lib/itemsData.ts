...
const uncommonTreasures: ItemDef[] = [
  ...
  { name: "Jade Ring", description: "A storage ring that adds 25 extra bag slots when equipped (total: 45 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "uncommon", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 25, icon: "💍" },
...
const rareTreasures: ItemDef[] = [
  ...
  { name: "Spirit Ring", description: "A spirit-infused ring that adds 40 extra bag slots when equipped (total: 60 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "rare", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 40, icon: "💍" },
  ...
  { name: "Cultivation Ring", description: "A cultivator's ring that adds 30 extra bag slots when equipped (total: 50 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "rare", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 30, icon: "💍" },
...
const epicTreasures: ItemDef[] = [
  ...
  { name: "Spatial Pouch", description: "A spatial artifact that adds 50 extra bag slots when equipped (total: 70 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "epic", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 50, icon: "👜" },
  ...
  { name: "Void Ring", description: "A void-forged ring that adds 60 extra bag slots when equipped (total: 80 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "epic", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 60, icon: "💍" },
...
const mythicTreasures: ItemDef[] = [
  ...
  { name: "Immortal Storage Ring", description: "An immortal-grade ring that adds 100 extra bag slots when equipped (total: 120 slots). Equip from your bag to expand storage.", category: "treasure", rarity: "mythic", effectType: "storage_equip", isStorageItem: true, storageSlotCount: 100, icon: "💍" },
